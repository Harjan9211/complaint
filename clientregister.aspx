<%@ Page Language="C#" AutoEventWireup="true" CodeFile="clientregister.aspx.cs" Inherits="complaint_register" %>
  ...
  <div class="shell">
    ...
    <div id="navigation">
      <ul>
							...
							<li><a href="loginclient.aspx">Client Login</a></li>
      </ul>
    </div>
    <div class="cl">&nbsp;</div>
  </div>
...
<div class="container">
  <div class="shell">
    <div class="main">
      ...
      <div class="content">
        <div class="post">
          <h2><a href="#">Cl</a>ient Registeration</h2>
    ...
    <div>
     <table border ="1">
         ...
         <tr><td colspan="2">
             <asp:Button ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click1" /></td></tr>
     </table>
    </div>
    </form>
          <p> </p>
